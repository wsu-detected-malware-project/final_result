...
namespace user_program.FormAll {
    public partial class Form3 : Form
    {
        ...
        private string protect_or_malware;
        ...
        public void LoadNamesFromColumnWithHighlight() //form3 애매한 값 줄 출력 변경
        {
            ...
            for (int i = 1; i < lines.Length; i++) // 첫 줄은 헤더
            {
                ...
                if (double.TryParse(columns[2], out double val))
                {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            {
                string wrapperPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "wrapper.exe");
                RegisterIFEO.RegisterWarnListToIFEO(); 
